...
class FastRCNN_Resnet18(
	...
	def __init__(self):
		...
		self.resnet18_seq = nn.Sequential(*list(resnet18.children())[:-2])
		...
		# ----- ROI Feature Vector -----
		size_proposal = 512 * pool_size_roi[0] * pool_size_roi[1]
		...
		self.layer:	Dict = {
			...
			self.Layer.RESNET18:	self.resnet18_seq,
