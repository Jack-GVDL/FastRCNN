...
class FastRCNN_Resnet50(
	...
	def __init__(self):
		...
		# ----- pretrained AlexNet -----
		# remove the last 2 layer
		resnet50 = models.resnet50(pretrained=True)
		self.resnet50_seq = nn.Sequential(*list(resnet50.children())[:-2])
		...
		self.roi_pool = torchvision.ops.RoIAlign(output_size=pool_size_roi, spatial_scale=0.032, sampling_ratio=-1)
		self.is_detach = True

		# ----- ROI Feature Vector -----
		size_proposal = 2048 * pool_size_roi[0] * pool_size_roi[1]
		...
		self.layer:	Dict = {
			...
			self.Layer.RESNET50:	self.resnet50_seq,
