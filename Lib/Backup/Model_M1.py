...
class FastRCNN(nn.Module):
	...
	def __init__(self):
		...
		# TODO: not sure if this need requires_grad or not
		...
		# TODO: is pretrained model does not need to train ?
		...
		for param in self.alexnet_seq.parameters():
	...
	def forward(self, image_list, roi_list, roi_index_list):
		...
		# FIXME: only use 3 out of 4 channel
		# x = x[:, :3, :, :]
		x = self.input_conv(x)
